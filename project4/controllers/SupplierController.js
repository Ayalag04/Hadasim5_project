...
const SupplierController = {
  ...
  login: async (req, res) => {
    ...
    try {
      ...
      SupplierModel.findSupplierByPhone(phone, (err, result) => {
        if (err) {
  ...
  getOrders: async (req, res) => {
    ...
    try {
      // קבלת הזמנות עבור הספק
      SupplierModel.getOrdersBySupplierId(supplierId, (err, orders) => {
        if (err) {
